...
//                     </div>
//                     <div>
//                         <h3 className="text-lg font-semibold text-gray-800">Shipping Services</h3>
//                         <p className="text-gray-600 text-sm">
//                             {isShippingActive 
//                                 ? "Shipping is active for your store" 
//                                 : "Activate shipping for your store"}
//                         </p>
//                     </div>
//                 </div>
        ...
        <div className="bg-white border rounded-lg p-6 shadow-sm">
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-gray-800">{t('shippingActivation.title')}</h3>
                        <p className="text-gray-600 text-sm">
                            {isShippingActive 
