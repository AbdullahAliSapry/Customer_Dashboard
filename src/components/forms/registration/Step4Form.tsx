...
//     .required('Bank certificate is required')
//     .test('fileSize', 'File size must be less than 5MB', function(value) {
//       if (!value || !(value instanceof File)) return false;
//       return value.size <= 5 * 1024 * 1024; // 5MB in bytes
//     })
//     .test('fileType', 'Invalid document (only PDF allowed)', function(value) {
//       if (!value || !(value instanceof File)) return false;
...
//                 name="accountNumber"
//                 className="p-2 outline-none"
//                 error={touched.accountNumber && errors.accountNumber ? errors.accountNumber : undefined}
//               />
...
//                 name="swiftCode"
//                 className="p-2 outline-none"
//                 error={touched.swiftCode && errors.swiftCode ? errors.swiftCode : undefined}
//               />
...
//                   error={touched.bankCertificate && errors.bankCertificate ? errors.bankCertificate : undefined}
//                 />
//               )}
//             </Field>
